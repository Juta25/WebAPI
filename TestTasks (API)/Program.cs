...
builder.Services.AddScoped<IPizzaRepository, PizzaDapperRepository>();//система на место объектов интерфейса IPizzaRepository будет передавать экземпляры класса PizzaRepository
